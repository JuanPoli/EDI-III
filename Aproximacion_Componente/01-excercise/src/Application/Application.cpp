...
int Application::run()
{
    ...
    //ComponentInterface* messageComponent = new Message();
    ...
    componentFactoryObject->setInterfaceName("IMessage");
    ComponentInterface* messageComponent = componentFactoryObject->createFrom("./Message");
    IMessage* messageObject = ( (IMessage*) messageComponent->getInstance() );
    greeterObject->greet(messageObject);
